...
class AddPatientActivity : AppCompatActivity(){
    ...
    private fun initUI() {
        ...
        btnAddPatient.setOnClickListener {
            val viewPatientIntent = Intent(this, ViewPatientActivity::class.java)
            startActivity(viewPatientIntent)
        }
    }

    private fun createAdapter(values: List<String>): SpinnerAdapter? {
        val dataAdapter = ArrayAdapter<String>(context, android.R.layout.simple_spinner_item, values!!.toMutableList())
